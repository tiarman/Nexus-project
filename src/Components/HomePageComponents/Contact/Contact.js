...
const Contact = () => {
  ...
  return (
    <section className="contact-container  pb-5" id='contact'>
            <Container> 
                    <h1 className="contact-font1 text-center" data-aos="fade-right" data-aos-offset="200" data-aos-easing="ease-in-sine"data-aos-duration="1000">Get In Touch</h1>
                    <p className="contact-font2 row col-md-8 text-center m-auto" data-aos="fade-left" data-aos-offset="200" data-aos-easing="ease-in-sine"data-aos-duration="1000">I'd Love to hear from you . Whether you have a question or just want to say hi, fell free to drop a message. I'll try my best to get back to you</p>
                    <div className="mt-4 pt-5" data-aos="fade-up" data-aos-duration="1000">
                        <form onSubmit={handleSubmit(onSubmit)} className="contact-form">
                            ...
                            <Button className='btn-hover btn btn-success color-2'>Send Message</Button>
                            </div>
                        </form>
                    </div>
             </Container>
