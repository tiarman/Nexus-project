...
import './Gallery.css'
import wilson from '../../../Images/info-emoji.svg'
import ema from '../../../Images/info-emoji.svg'
import aliza from '../../../Images/info-emoji.svg'
        ...
        <section className="testimonials">
            <div className="container">
                <div className="section-title">
                    <h1 className="test-header mb-5">Country</h1>
                </div>
            </div>
